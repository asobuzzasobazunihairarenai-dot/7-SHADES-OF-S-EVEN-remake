...
export const CHANGELOG = [
  {
    date: "2026-08-18",
    items: [
      "カードを盤面のマスに置くとき、手札からマスの真上へすーっと滑り、上空で止まってストンと落ちて配置され、着地の瞬間にカードの周りに風・ホコリがふわっと舞う演出を追加しました。逆に、マスのカードを手札へ戻すときも、マスから持ち上がって手札へ滑り込む演出になります（ドラッグ＆ドロップでの配置・回収が対象。動作を軽くしたい時はオプションの「アニメーションを減らす」でオフにできます）。",
