...
export const CHANGELOG = [
  {
    ...
    items: [
      ...
      "【ランク戦】3〜4人のランク戦に対応しました。マッチメイク（自動で相手を探す）では、開始時に人数（2〜4人）を選べます（同じ人数を選んだ人同士でマッチ）。合言葉フレンド戦でも、部屋に2〜4人集まれば開始できます。順位は「7色ロックの勝者=1位、以降はロックできていた色の数が多い順」で決まり、人数に応じたポイント表でレートに反映されます。",
      "【ランク戦】別のタブやアプリを見ている時でも、対戦相手が見つかった時・待機中の相手が現れた時にブラウザ通知とタブのアイコン（ファビコン）点滅で気づけるようにしました（初回に通知の許可を求めます。特にキュー待ち中に別タブへ移っていても、マッチのレディチェックを見逃しにくくなります）。",
