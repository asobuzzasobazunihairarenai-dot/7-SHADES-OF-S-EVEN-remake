...
export const CHANGELOG = [
  {
    ...
    items: [
      ...
      "勝利演出で7色が1つずつ灯る時の音を作り直しました。1音ごとに音程がずり下がって安っぽく聞こえていたのをやめ、澄んだ鐘の響きにしています。7色が同時に灯る最後の瞬間は和音になります。",
    ],
    itemsEn: [
      ...
      "Reworked the sound of the seven colours lighting up one by one in the victory sequence. Each note used to slide down in pitch, which sounded cheap; it now rings like a clear bell, and the final all-colours flash plays a chord.",
    ],
    devItems: [
      ...
      "【管理者向け】勝利の鐘は打撃音用の合成関数（鳴っている間に音程が0.6倍まで滑り落ちる）を流用していたのが原因でした。鐘専用の組み立てに替え、管理者モードの「🏆 勝利演出: 色が灯る音（聴き比べ）」から 澄んだ鐘／鐘＋きらめき／以前のまま を試聴して選べます。",
    ...
    devItemsEn: [
      ...
      "[Admin] The victory chime was built on the percussion helper, whose pitch slides down to 0.6x while it rings — that slide was the cheap sound. It now uses a bell-specific builder, and admin mode has a listening comparison (clear bell / bell with sparkle / previous version) with a preview button.",
