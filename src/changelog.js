...
export const CHANGELOG = [
  {
    ...
    items: [
      ...
      "駒に遅れて追従する飾りのペット（🐥・仮）を追加しました。ゲームには一切関係ない見た目だけの要素です（今後、着せ替えや本番の絵に育てる予定）。ペットが駒とズレて表示される不具合を修正。ペットは各プレイヤーの「自ゲート側」に立ち、うろうろ歩く・小さく跳ねる・たまに高く飛ぶ・止まるをランダムに行います（全員バラバラの動き）。管理者モードで位置・大きさ・追従速度・うろつき範囲・跳ねる激しさを微調整できます。",
