...
export const CHANGELOG = [
  {
    date: "2026-08-06",
    items: [
      "🤖 CPU戦（1人用・ベータ）を追加しました。タイトル画面の「CPU戦」ボタンから、ログイン不要であなた対CPUの対戦をこの端末だけで遊べます。CPUの手はまだランダムです（今後かしこくしていきます）。まれにCPUの番で処理が止まることがあれば、不具合報告からアクションログ付きで教えていただけると助かります。",
